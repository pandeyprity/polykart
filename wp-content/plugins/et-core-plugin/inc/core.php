...
//		}
	...
	function required_theme_notice(){
	    ...
	    if (  $theme->name == ('XStore') &&  version_compare( $theme->version, ET_CORE_THEME_MIN_VERSION, '<' ) ) {
	    	$video = '<a class="et-button" href="https://www.youtube.com/watch?v=kPo0fiNY4to" target="_blank" style="color: white!important; text-decoration: none"><span class="dashicons dashicons-video-alt3" style="color: var(--et_admin_main-color, #A4004F);"></span> Video tutorial</a>';
	      	echo '
