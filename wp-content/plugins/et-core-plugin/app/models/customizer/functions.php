                    ...
                    <div class="et-content">
                        ...
                        <form class="woocommerce-form woocommerce-form-login login <?php if ( $with_tabs ) {
							echo 'et_b-tab-content active';
                              ...
                              action="<?php echo apply_filters( 'header_account_link', get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ); ?>" style="border: 1px solid #D4D4D4; padding: 28px; !important; font-size: 16px !important; margin-top: 20px; font-weight: normal !important;">
						...
						<?php if ( $with_tabs ) : ?>
                            <form method="post" autocomplete="off"
                                  ...
                                  action="<?php echo get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ?>" style="border: 1px solid #D4D4D4; padding: 40px; color: #555555 !important; font-size: 16px !important; font-weight: normal !important;"
>
                                ...
                                <p class="woocommerce-form-row woocommerce-form-row--wide form-row-wide">
									<input type="email" class="woocommerce-Input woocommerce-Input--text input-text"
										...
										placeholder="<?php esc_html_e( 'Email ID', 'xstore-core' ); ?>"
