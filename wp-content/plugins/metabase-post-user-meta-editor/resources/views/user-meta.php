<div id="metabase-app" x-data="metabase" x-init="init(<?php esc_attr_e(wp_json_encode($data)); ?>)" class="meta-box-sortables ui-sortable">
  <div id="metabase" class="postbox ">
    <div class="postbox-header" x-on:click="openTab = !openTab">
      <h2 class="hndle ui-sortable-handle tw-m-0 tw-px-4 tw-py-2 tw-text-sm">Meta</h2>
      <div class="handle-actions hide-if-no-js">

        <span class="tw-ml-6 tw-h-7 tw-flex tw-items-center tw-text-gray-500 tw-mr-3">
          <svg class="tw-h-6 tw-w-6 tw-transform tw--rotate-180" x-state:on="Open" x-state:off="Closed" :class="{ 'tw--rotate-180': openTab, 'tw-rotate-0': !(openTab) }" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
