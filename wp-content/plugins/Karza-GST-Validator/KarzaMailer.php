...
class KarzaMailer{
    ...
    public static function sendmail($record, $api_setting){
        // print_r($record);
        // print_r($api_setting);

        $subject="Credit Request by ".$record->trade_name;
        $message = KarzaMailer::mail_template($record);
        $headers = array('Content-Type: text/html; charset=UTF-8');
        $attachments = WP_CONTENT_DIR . "/uploads/karza-gst-document/". $record->pdf_file;

        $is_sent=wp_mail($api_setting->email_to, $subject, $message, $headers, $attachments);
        if($is_sent){
            return true;
        }
        return false;
    ...
    public static function mail_template($record){
        
        $attachments = home_url(). "/wp-content/uploads/karza-gst-document/". $record->pdf_file;
        $template='
        <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
            ...
            <div alt="Confirm email" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;border-radius:100px" width="100" title="Confirm email">
                <img src="https://polykart.co/wp-content/uploads/2023/03/Black-logo-no-background.svg" style="width: 100px; height: 35px"/>
            </div>
            </td>
            </tr>
            </table></td>
            ...
            <tr>
            <td align="left" style="padding:20px;Margin:0"><h3 style="Margin:0;line-height:34px;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;font-size:28px;font-style:normal;font-weight:bold;color:#2D3142">Hi</h3><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px"><br></p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">You have received a credit request by '.$record->trade_name.'<br><br>Trade Name : '.$record->trade_name.'<br></p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">GST IN&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: '.$record->gst_no.'<br>Address&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;: '.$record->address.'<br><br></p></td>
            </tr>
            </table></td>
            </tr>
            </table></td>
            ...
            <a href="'.$attachments.'" target="_blank">
                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="'.$attachments.'"
                style="height:56px; v-text-anchor:middle; width:520px" arcsize="50%" stroke="f" fillcolor="#0b3954">
                <w:anchorlock></w:anchorlock>
                <center style=color:#ffffff; font-family:Imprima, Arial, sans-serif; font-size:22px; font-weight:700; line-height:22px; mso-text-raise:1px>GST Report -'.$attachments.'-</center>
                </v:roundrect>
            </a>
            <![endif]--><!--[if !mso]><!-- -->
            <span class="msohide es-button-border" style="border-style:solid;border-color:#2CB543;background:#0b3954;border-width:0px;display:block;border-radius:30px;width:auto;mso-border-alt:10px;mso-hide:all">
                <a href="'.$attachments.'" class="es-button msohide" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:22px;padding:15px 20px 15px 20px;display:block;background:#0b3954;border-radius:30px;font-family:Imprima, Arial, sans-serif;font-weight:bold;font-style:normal;line-height:26px;width:auto;text-align:center;mso-hide:all;padding-left:5px;padding-right:5px;border-color:#0b3954">
                    GST Report
                </a>
            </span><!--<![endif]--></td>
            </tr>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
            <tr>
            <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">Thanks,<br><br>Polykart</p></td>
            </tr>
            <tr>
