...
add_filter( $hook, function ( $fields ) {
	...
	$args = array(
		'enable_swatch' => array(
			...
			'tooltip' => sprintf(esc_html__( 'Enable this option to replace the old-fashioned dropdown fields on your variable products with our built-in color, image, and label %1s.', 'xstore' ),
                '<a href="https://xstore.helpscoutdocs.com/article/94-variation-swatches" target="_blank" rel="nofollow">'.esc_html__('variation swatches', 'xstore').'</a>'),
