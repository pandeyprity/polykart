...
<!--        <li data-network="mail-chimp" class="<?php echo 'mail-chimp' == $active_tab ? 'active' : ''; ?>">-->
...
<div class="etheme-div etheme-social-tab etheme-social-google-map <?php echo 'google-map' != $active_tab ? 'hidden' : ''; ?>">
    <form>
        ...
        <p class="et-message et-info">If you don't have api key, please, click <a href="https://developers.google.com/maps/documentation/javascript/get-api-key">here</a> to generate one.</p>
        <p>
