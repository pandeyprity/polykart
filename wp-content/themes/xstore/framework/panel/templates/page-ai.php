<h2 class="etheme-page-title etheme-page-title-type-2"><?php esc_html_e('XStore OpenAI Assistant', 'xstore'); ?></h2>
<form>
	...
	<p>
        ...
        <input class="etheme-network-save et-button et-button-green no-loader" data-network="open-ai" type="submit" value="<?php echo esc_attr('Save', 'xstore'); ?>">
	</p>
