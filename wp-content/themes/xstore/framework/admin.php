...
function et_ai_msg(){
    ...
    if (class_exists( 'WooCommerce' )){
        ...
        $woo_msg = '
            <p>'.esc_html__('Additionally, you can generate content for your, products by going to', 'xstore').' <a href="'. $url .'" target="_blank">'.esc_html__('WooCommerce -> Products -> Edit', 'xstore').'</a> '.esc_html__('and scrolling down to the
            bottom of  the page.', 'xstore').'</p>
        ';
    }
    ...
    return '
        <div class="et_ai-saved-options">
            <br>
            <p>'.esc_html__('To use ChatGPT (OpenAI) functionality, please visit your', 'xstore').'
            <a href="'. $url .'" target="_blank">'.esc_html__('WordPress Dashboard -> Pages -> Choose Page and Edit it ->  
            Scroll down', 'xstore').'</a> '.esc_html__('to the bottom of the page, and you will find the XStore AI Assistant tab.', 'xstore').'</p>'.$woo_msg.'
        </div>
    ';
}
